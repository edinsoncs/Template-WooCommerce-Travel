...
if ( $customer_orders ) : ?>
	...
	<div class="header--Pedidos">
		<h2 class="title"><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'woocommerce' ) ); ?></h2>
	</div>
		...
		<tbody><?php
			foreach ( $customer_orders as $customer_order ) {
				...
				?><tr class="order">
					...
					<td class="order-status" data-title="<?php esc_attr_e( 'Status', 'woocommerce' ); ?>" style="white-space:nowrap;">
